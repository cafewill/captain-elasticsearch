...
final class ElasticsearchSender {
    private static final HostnameVerifier NOOP_VERIFIER = (hostname, session) -> true;

    private final ObjectMapper objectMapper;
    private final String url;
    private final ElasticsearchAuthentication authentication;
    private final int connectTimeout;
    private final int readTimeout;
    private final SSLSocketFactory sslSocketFactory;
    private final ElasticsearchHeaders headers;

    ElasticsearchSender(ObjectMapper objectMapper,
                     String url,
                     ElasticsearchAuthentication authentication,
                     int connectTimeout,
                     int readTimeout,
                     boolean trustAllSsl,
                     ElasticsearchHeaders headers) {
