...
import com.github.cafewill.elasticsearch.AbstractElasticsearchAppender;
import com.github.cafewill.elasticsearch.ClassicElasticsearchPublisher;
...
public class ElasticsearchAppenderTest {
    ...
    public void should_not_publish_events_when_logger_set() {
        String loggerName = "elasticsearch-debug-log";
    ...
    public void should_not_publish_events_when_errorlogger_set() {
        String errorLoggerName = "elasticsearch-error-log";
        ILoggingEvent eventToLog = mock(ILoggingEvent.class);
    ...
    public void should_delegate_setters_to_settings() throws MalformedURLException {
        ...
        int maxQueueSize = 10;
        String logger = "elasticsearch-logger";
        String url = "http://myelasticsearch.mycompany.com";
        String errorLogger = "elasticsearch-error-logger";
