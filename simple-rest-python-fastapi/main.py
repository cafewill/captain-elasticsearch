...
import db
from elasticsearch_appender.web_appender_fastapi import ElasticsearchWebAppender
...
def env_headers():
    return json.loads(os.environ.get('ELASTICSEARCH_HEADERS', '{}'))


appender = ElasticsearchWebAppender(
    url                   = os.environ.get('ELASTICSEARCH_URL',      'http://localhost:9200'),
    username              = os.environ.get('ELASTICSEARCH_USERNAME', ''),
    password              = os.environ.get('ELASTICSEARCH_PASSWORD', ''),
    app                   = os.environ.get('ELASTICSEARCH_NAME',     'simple-rest-python-fastapi'),
    env                   = os.environ.get('ELASTICSEARCH_ENV',      'local'),
    max_batch_bytes       = int(os.environ.get('ELASTICSEARCH_BATCH_MAX_BYTES',      '1000000')),
    flush_interval_seconds= int(os.environ.get('ELASTICSEARCH_BATCH_FLUSH_INTERVAL', '1')),
    queue_size            = int(os.environ.get('ELASTICSEARCH_BATCH_QUEUE_SIZE',     '8192')),
    operation             = os.environ.get('ELASTICSEARCH_BULK_OPERATION', 'index'),
